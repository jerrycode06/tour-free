...
const hotelsData = [
  {
    ...
    nights: "Per Night Per Room",
    price: "AED 199",
    inclusions: "1 Night Accommodation Standard Room",
    terms: [
      ...
      "Booking is canceled if full payment is not received within 15 days of departure.",
    ],
  },
  {
    ...
    nights: "Per Night Per Room",
    price: "AED 275",
    inclusions: "2 Night Accommodation Standard Room",
    terms: [
  ...
  },
  {
    ...
    nights: "Per Night Per Room",
    price: "AED 375",
    inclusions: "3 Night Accommodation Standard Room",
    terms: [
      "Rates may change during peak seasons or due to schedule changes.",
      "Final vouchers are issued only after full payment is received.",
      "Booking is canceled if full payment is not received within 15 days of departure.",
