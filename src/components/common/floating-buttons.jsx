    ...
    <div className="z-10 fixed flex gap-3 w-full justify-end items-center bottom-2">
      <style>
        {`
            ...
            scrollbar-color: #fe8000 #225822d6;
          }

          #enquiry-form-id::-webkit-scrollbar {
            width: 8px;
          }

          #enquiry-form-id::-webkit-scrollbar-thumb {
            background-color: #fe8000;
            border-radius: 10px;
            border: 2px solid #225822d6;
          }

          #enquiry-form-id::-webkit-scrollbar-track {
            background-color: #225822d6;
            border-radius: 10px;
          }
        `}
      </style>
